...
UserAdministration.Asignacion = function (url, id) {
    ...
    this.$list = function () {
        return "fields=tarea_id,user_id,derivacion";
    };
    this.$name = "Asignacion";
    this.$pluralName = "Asignacions";
    this.$title = "Asignación";
    this.$pluralTitle = "Asignaciones";
    this.$ = {"tarea_id":{"name":"tarea_id","label":"Tarea","type":"text","enum":[],"source":undefined,"textField":undefined,"value":"tarea_id","isAssociation":false},"user_id":{"name":"user_id","label":"Usuario","type":"text","enum":[],"source":undefined,"textField":undefined,"value":"user_id","isAssociation":false},"derivacion":{"name":"derivacion","label":"# de derivación","type":"text","enum":[],"source":undefined,"textField":undefined,"value":"derivacion","isAssociation":false}};
    this.$fields = function () {
        return this.object2array(this.$, "item");
    };
    this.$columns = function () {
        return [{"title":"Tarea","data":"attributes.tarea_id"},{"title":"Usuario","data":"attributes.user_id"},{"title":"# de derivación","data":"attributes.derivacion"}];
    };
    this.$methods = {
    };
    this.$initFields();
