...
UserAdministration.User = function (url, id) {
  ...
  this.$ = {
    ...
    role: {
      ...
      type: "select",
      enum: [],
      source: new UserAdministration.Role(),
      textField: function (data) {
        return data ? data.name : "";
      },
      value: "role",
  ...
  this.$columns = function () {
    return [
      { title: "Usuario", data: "attributes.username" },
      { title: "Nombres", data: "attributes.nombres" },
      { title: "Apellidos", data: "attributes.apellidos" },
      {
        title: "Fotografia",
        data: "attributes.fotografia",
        render: function (data) {
          return data ? data.name : "";
        },
      },
      { title: "Nro de CI", data: "attributes.numero_ci" },
    ];
  };
  this.$methods = {
    registrar: function (data, methodCallback, childrenAssociation) {
      self.$call(
        "registrar",
        { data: data },
        childrenAssociation,
...
UserAdministration.Empresa = function (url, id) {
  ...
  this.$ = {
    ...
    detalle_empresa: {
      ...
      label: "detalle_empresa",
      type: "text",
      enum: [],
      source: undefined,
      textField: undefined,
      value: "detalle_empresa",
      isAssociation: false,
    },
    sub_empresa: {
      name: "sub_empresa",
  ...
  this.$columns = function () {
    return [
      { title: "Código", data: "attributes.cod_empresa" },
      { title: "Empresa", data: "attributes.nombre_empresa" },
      { title: "Caracter", data: "attributes.caracter" },
      { title: "Rubro", data: "attributes.rubro" },
    ];
  };
  this.$methods = {
    eeff: function (gestion, eeff, methodCallback, childrenAssociation) {
      self.$call(
        "eeff",
        { gestion: gestion, eeff: eeff },
        childrenAssociation,
        methodCallback
      );
    },
    procedencias: function (methodCallback, childrenAssociation) {
      self.$call("procedencias", {}, childrenAssociation, methodCallback);
    },
  };
  this.$initFields();
  if (id) {
...
UserAdministration.EstadoFinanciero = function (url, id) {
  ...
  this.$ = {
    ...
    empresa: {
      ...
      type: "select",
      enum: [],
      source: new UserAdministration.Empresa(),
      textField: function (data) {
        return data
          ? (data.cod_empresa ? data.cod_empresa : "   ") +
              " " +
              data.nombre_empresa
          : "";
      },
  ...
  this.$columns = function () {
    return [
      {
        title: "Tipo estado financiero",
        data: "attributes.tipo_estado_financiero",
      },
      { title: "Gestión", data: "attributes.gestion" },
      {
        title: "Archivo",
        data: "attributes.archivo",
        render: function (data) {
          return data ? data.name : "";
        },
      },
      {
        ...
        data: "relationships.empresa.attributes",
      },
    ];
  };
  this.$methods = {};
...
UserAdministration.CuadroFinanciero = function (url, id) {
  ...
  this.$columns = function () {
    return [
      { title: "Título", data: "attributes.titulo" },
      { title: "Formula (html)", data: "attributes.contenido" },
      { title: "Grafico (json)", data: "attributes.grafico" },
    ];
  };
  this.$methods = {
    calculate: function (
...
UserAdministration.EmpresaGrafico = function (url, id) {
  ...
  this.$columns = function () {
    return [
      { title: "Título", data: "attributes.titulo" },
      { title: "Tipo", data: "attributes.tipo" },
      { title: "Informes auditoria", data: "attributes.informes_auditoria" },
      { title: "Datos", data: "attributes.datos" },
    ];
  };
  this.$methods = {};
  this.$initFields();
...
UserAdministration.EmpresaEstado = function (url, id) {
  ...
  this.$columns = function () {
    return [
      { title: "Tipo", data: "attributes.nombre_empresa" },
      { title: "Gestión", data: "attributes.gestion" },
    ];
  };
  this.$methods = {};
...
UserAdministration.Lafirma = function (url, id) {
  ...
  this.$columns = function () {
    return [
      { title: "Código", data: "attributes.cod_firma" },
      { title: "Nombre empresa", data: "attributes.nombre_empresa" },
    ];
  };
  this.$methods = {};
  this.$initFields();
...
UserAdministration.Firma = function (url, id) {
  ...
  this.$ = {
    ...
    representante_legal: {
      ...
      type: "select",
      enum: [],
      source: new UserAdministration.Lafirma(),
      textField: "nombre_empresa",
  ...
  this.$columns = function () {
    return [
      { title: "Código", data: "attributes.cod_firma" },
      {
        ...
        data: "attributes.documento_firma",
        render: function (data, type, row) {
          if (!data) {
            return "";
          }
      ...
      },
      {
        ...
        data: "relationships.empresa.attributes.nombre_empresa",
      },
      {
        title: "Firma de auditoria",
        visible: true,
        render: function (data, type, full, meta) {
          return data ? data : "";
        },
        data: "relationships.representante_legal.attributes.nombre_empresa",
      },
      {
        title: "Informes SCEP",
        data: "attributes.informes",
        render: function (data, type, row) {
          var res = [];
          if (data && typeof data.forEach === "function") {
            data.forEach(function (item) {
      ...
      {
        title: "Dictamen o Informe",
        data: "attributes.informe_dictamen",
        render: function (data, type, row) {
          if (!data) {
            return "";
          }
      ...
      { title: "Gestión", data: "attributes.gestion" },
      {
        ...
        data: "relationships.owner.attributes",
      },
      {
        title: "Supervisor",
        visible: true,
        ...
        data: "relationships.supervisor.attributes",
      },
    ];
  };
  this.$methods = {
    listEditButton: function (data, type, row, meta) {
      var owner_id = row.relationships.owner
        ? row.relationships.owner.id
        : false;
...
UserAdministration.Contratacion = function (url, id) {
  ...
  this.$columns = function () {
    return [
      { title: "Número de Informe", data: "attributes.cod_firma" },
      {
        title: "Documento adjunto informe",
        data: "attributes.informe_scep",
        render: function (data, type, row) {
          if (!data) {
            return "";
          }
      ...
      {
        title: "Documento adjunto nota emitida",
        data: "attributes.nota",
        render: function (data, type, row) {
          if (!data) {
            return "";
          }
  ...
  this.$methods = {
    listEditButton: function (data, type, row, meta) {
      var owner_id = row.relationships.owner
        ...
        : false;
      var canEdit =
        owner_id == localStorage.user_id || localStorage.user_id == 1;
      return canEdit ? true : "";
    },
  };
  this.$initFields();
...
UserAdministration.Uai = function (url, id) {
  ...
  this.$ = {
    ...
    tipo_de_informes: {
      ...
      source: undefined,
      textField: undefined,
      value: "tipo_de_informes",
      isAssociation: false,
    },
    informes_emitidos_scep: {
      ...
      textField: function (data, type, row) {
        ...
        var time = row.attributes.updated_at
          ...
          : "";
        var owner =
          typeof row.relationships.owner === "undefined" ||
          !row.relationships.owner
            ? ""
  ...
  this.$columns = function () {
    return [
      { title: "Código", data: "attributes.cod_uai" },
      { title: "Gestión", data: "attributes.gestion_uai" },
      {
        title: "Empresa",
        visible: true,
        render: function (data, type, full, meta) {
      ...
      { title: "Tipo de Informes", data: "attributes.tipo_de_informes" },
      {
        title: "Informes emitidos SCEP",
        data: "attributes.informes_emitidos_scep",
        render: function (data, type, row) {
          if (!data) {
            return "";
          }
...
UserAdministration.Tarea = function (url, id) {
  ...
  this.$columns = function () {
    return [
      { title: "Código", data: "attributes.cod_tarea" },
      {
        title: "Creador",
        visible: true,
        render: function (data) {
        ...
        data: "relationships.creador.attributes",
      },
      {
        title: "Usuarios",
        visible: true,
        ...
        data: "relationships.usuarios.attributes",
      },
      { title: "Tarea", data: "attributes.nombre_tarea" },
      { title: "Descripción", data: "attributes.descripcion" },
      { title: "Fecha inicio", data: "attributes.fecha_ini" },
      { title: "Fecha finalización", data: "attributes.fecha_fin" },
      { title: "Estado", data: "attributes.estado" },
      { title: "Avance", data: "attributes.avance" },
      { title: "Prioridad", data: "attributes.prioridad" },
      { title: "días otorgados", data: "attributes.dias_otorgados" },
      { title: "Nro de control", data: "attributes.nro_de_control" },
      { title: "Gestion de la hoja de ruta", data: "attributes.gestion" },
      { title: "Tipo de tarea", data: "attributes.tipo" },
      { title: "Datos de la tarea", data: "attributes.datos" },
    ];
  };
  this.$methods = {};
  this.$initFields();
...
UserAdministration.Asignacion = function (url, id) {
  ...
  this.$columns = function () {
    return [
      { title: "Tarea", data: "attributes.tarea_id" },
      { title: "Usuario", data: "attributes.user_id" },
      { title: "Nro asignación", data: "attributes.nro_asignacion" },
      { title: "Días plazo", data: "attributes.dias_plazo" },
    ];
  };
  this.$methods = {};
  this.$initFields();
...
UserAdministration.Login = function (url, id) {
  ...
  this.$columns = function () {
    return [
      { title: "username", data: "attributes.username" },
      { title: "password", data: "attributes.password" },
      { title: "token", data: "attributes.token" },
    ];
  };
  this.$methods = {
    validate: function (
...
UserAdministration.Recover = function (url, id) {
  ...
  this.$columns = function () {
    return [
      { title: "account", data: "attributes.account" },
      { title: "key", data: "attributes.key" },
    ];
  };
  this.$methods = {
    sendEmail: function (account, methodCallback, childrenAssociation) {
      self.$call(
        "sendEmail",
        { account: account },
        childrenAssociation,
...
UserAdministration.Documento = function (url, id) {
  ...
  this.$columns = function () {
    return [
      { title: "Nombre", data: "attributes.nombre" },
      { title: "Archivo", data: "attributes.archivo" },
    ];
  };
  this.$methods = {};
  this.$initFields();
...
UserAdministration.HojaTrabajo = function (url, id) {
  ...
  this.$columns = function () {
    return [
      { title: "Título de la hoja de trabajo", data: "attributes.titulo" },
      { title: "ID de templeta", data: "attributes.templeta" },
      { title: "Gestión", data: "attributes.gestion" },
      { title: "Valores llenados", data: "attributes.valores" },
    ];
  };
  this.$methods = {};
  this.$initFields();
...
UserAdministration.ClasificacionEmpresa = function (url, id) {
  ...
  this.$columns = function () {
    return [
      { title: "Clasificación", data: "attributes.clasificacion" },
      { title: "Conteo", data: "attributes.conteo" },
    ];
  };
  this.$methods = {};
  this.$initFields();
...
UserAdministration.ClasificacionEmpresa.prototype = Object.create(
  Model.prototype
);
