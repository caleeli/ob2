...
ReportsFolders.Variable = function (url, id) {
    ...
    this.$ = {"name":{"name":"name","label":"Nombre","type":"text","enum":[],"source":undefined,"textField":undefined,"value":"name","isAssociation":false},"description":{"name":"description","label":"Descripción","type":"text","enum":[],"source":undefined,"textField":undefined,"value":"description","isAssociation":false},"image":{"name":"image","label":"Imagen","type":"text","enum":[],"source":undefined,"textField":undefined,"value":"image","isAssociation":false},"aggregator":{"name":"aggregator","label":"Agregación","type":"select","enum":["sum","max","min","avg"],"source":undefined,"textField":undefined,"value":"aggregator","isAssociation":false},"rows":{"name":"rows","label":"Filas","type":"tags","enum":[],"source":function (){
                        ...
                        },"textField":"name","value":"filter","isAssociation":false},"information_source":{"name":"information_source","label":"Fuente de información","type":"text","enum":[],"source":undefined,"textField":undefined,"value":"information_source","isAssociation":false},"periodicity":{"name":"periodicity","label":"Periodicidad","type":"text","enum":[],"source":undefined,"textField":undefined,"value":"periodicity","isAssociation":false},"chart_type":{"name":"chart_type","label":"Tipo de gráfico","type":"select","enum":["bar","bar2","horizontalBar","area","line","pie","polarArea","pivot"],"source":undefined,"textField":undefined,"value":"chart_type","isAssociation":false},"dimensions":{"name":"dimensions","label":"dimensions","type":"tags","enum":[],"source":function (){
